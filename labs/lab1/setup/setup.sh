...
LAB="lab1"
NEXT_LAB="lab2"          # set to "" on the final lab
NEXT_LAB_NAME="Lab 2 - RAG and semantic ingestion attacks"
...
printf '\n'; hr
printf '  Starting the lab. You will TYPE five commands.\n'
...
printf '\n'
if docker cp "$CONTAINER:/labs/lab1/lab1-results.txt" "$RESULTS" >/dev/null 2>&1; then
...
printf '\n'; hr
printf '  Lab 1 complete. The image stays on your machine for the next lab.\n'
hr; printf '\n'
