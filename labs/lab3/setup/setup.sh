#!/usr/bin/env bash
# ===========================================================================
#  SecLLM Bootcamp - Lab 3 setup  (macOS and Linux)
#
...
LAB="lab3"
NEXT_LAB="lab4"          # set to "" on the final lab
NEXT_LAB_NAME="Lab 4 - Multimodal and vision-based exploits"
CONTAINER="seclm-lab3-run"
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
RESULTS="$HERE/lab3-results.txt"
EXTRA_ARGS=("$@")
...
printf '\n'; hr
printf '  SecLLM Bootcamp - Lab 3: Advanced prompt injection\n'
...
printf '\n'
if docker cp "$CONTAINER:/labs/lab3/lab3-results.txt" "$RESULTS" >/dev/null 2>&1; then
...
printf '\n'; hr
printf '  Lab 3 complete. The image stays on your machine for the next lab.\n'
hr; printf '\n'
