# ===========================================================================
#  SecLLM Bootcamp - Lab 3 setup  (Windows)
#
...
$Lab       = 'lab3'
$NextLab   = 'lab4'          # set to '' on the final lab
$NextName  = 'Lab 4 - Multimodal and vision-based exploits'
$Container = 'seclm-lab3-run'
$Here      = Split-Path -Parent $MyInvocation.MyCommand.Path
$Results   = Join-Path $Here 'lab3-results.txt'
...
Write-Host ""
Hr
Write-Host "  SecLLM Bootcamp - Lab 3: Advanced prompt injection"
...
Write-Host ""
& docker cp "$Container`:/labs/lab3/lab3-results.txt" $Results *> $null
...
Write-Host ""
Hr
Write-Host "  Lab 3 complete. The image stays on your machine for the next lab."
Hr
Write-Host ""
Read-Host "Press Enter to close"
