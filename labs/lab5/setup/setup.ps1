# ===========================================================================
#  SecLLM Bootcamp - Lab 5 setup  (Windows)
#
...
$Lab       = 'lab5'
$NextLab   = 'lab6'          # set to '' on the final lab
$NextName  = 'Lab 6 - MCP and interface hijacking'
$Container = 'seclm-lab5-run'
$Here      = Split-Path -Parent $MyInvocation.MyCommand.Path
$Results   = Join-Path $Here 'lab5-results.txt'
...
# No -p: lab 5 does not serve.
& docker run -it --name $Container $Tag lab 5 @ExtraArgs
$runRc = $LASTEXITCODE

# --- 9. Recover the transcript ----------------------------------------------
Write-Host ""
& docker cp "$Container`:/labs/lab5/lab5-results.txt" $Results *> $null
...
Write-Host ""
Hr
Write-Host "  Lab 5 complete. The image stays on your machine for the next lab."
Hr
Write-Host ""
Read-Host "Press Enter to close"
