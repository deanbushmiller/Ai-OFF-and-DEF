...
def fail(msg):
    ...
    say(" Send lab15-results.txt to the instructor through GitHub.")
    rule()
    sys.exit(1)
...
def main():
    ...
    say("           (orthogonality). AML.M0039 AI Honeypots is the one we name")
    say("")
    say("  Read that ATLAS line twice. Six of the seven mitigations ATLAS maps")
