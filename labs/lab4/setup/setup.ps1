# ===========================================================================
#  SecLLM Bootcamp - Lab 4 setup  (Windows)
#
...
$Lab       = 'lab4'
$NextLab   = 'lab5'          # set to '' on the final lab
$NextName  = 'Lab 5 - Exploiting AI agents and excessive agency'
$Container = 'seclm-lab4-run'
$Here      = Split-Path -Parent $MyInvocation.MyCommand.Path
$Results   = Join-Path $Here 'lab4-results.txt'
$Invoices  = Join-Path $Here 'lab4-invoices'
...
Write-Host ""
Hr
Write-Host "  SecLLM Bootcamp - Lab 4: Multimodal and vision-based exploits"
...
# No -p: lab 4 does not serve.
& docker run -it --name $Container $Tag lab 4 @ExtraArgs
$runRc = $LASTEXITCODE

# --- 9. Recover the transcript ----------------------------------------------
Write-Host ""
& docker cp "$Container`:/labs/lab4/lab4-results.txt" $Results *> $null
...
& docker cp "$Container`:/labs/lab4/invoices" $Invoices *> $null
if ($LASTEXITCODE -eq 0) {
...
Write-Host ""
Hr
Write-Host "  Lab 4 complete. The image stays on your machine for the next lab."
Hr
Write-Host ""
Read-Host "Press Enter to close"
