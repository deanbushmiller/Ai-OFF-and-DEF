# ===========================================================================
#  SecLLM Bootcamp - Lab 6 setup  (Windows)
#
...
$Lab       = 'lab6'
$NextLab   = 'lab7'          # set to '' on the final lab
$NextName  = 'Lab 7 - AI-powered attack orchestration'
$Container = 'seclm-lab6-run'
$Here      = Split-Path -Parent $MyInvocation.MyCommand.Path
$Results   = Join-Path $Here 'lab6-results.txt'
...
Write-Host ""
Hr
Write-Host "  SecLLM Bootcamp - Lab 6: MCP and interface hijacking"
...
# No -p: lab 6 does not serve.
& docker run -it --name $Container $Tag lab 6 @ExtraArgs
$runRc = $LASTEXITCODE

# --- 9. Recover the transcript ----------------------------------------------
Write-Host ""
& docker cp "$Container`:/labs/lab6/lab6-results.txt" $Results *> $null
if ($LASTEXITCODE -eq 0) {
    Ok "Results saved: $Results"
    Info "Paste the wire log and the assistant answers from the evidence block."
} else {
...
Write-Host ""
Hr
Write-Host "  Lab 6 complete. The image stays on your machine for the next lab."
Hr
Write-Host ""
Read-Host "Press Enter to close"
