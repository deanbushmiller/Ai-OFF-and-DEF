...
if ($alreadyHave) {
    ...
    Write-Host "  If you still have lab 1 on this machine, almost all of this is"
    Write-Host "  already here and the download is well under a megabyte. From a"
    Write-Host "  clean machine it is about 305 MB on Intel and takes a couple"
    Write-Host "  of minutes."
    Write-Host "  $Tag"
    Hr
    Write-Host ""
    & docker pull $Tag
