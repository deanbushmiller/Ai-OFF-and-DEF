#!/usr/bin/env bash
# ===========================================================================
#  SecLLM Bootcamp - Lab 9 setup  (macOS and Linux)
#
...
LAB="lab9"
NEXT_LAB="lab10"         # set to "" on the final lab
NEXT_LAB_NAME="Lab 10 - Defending RAG ingestion"
CONTAINER="seclm-lab9-run"
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
RESULTS="$HERE/lab9-results.txt"
EXTRA_ARGS=("$@")
...
printf '\n'; hr
printf '  SecLLM Bootcamp - Lab 9: Defending the model supply chain\n'
...
# That reasoning does not survive contact with this lab: lab 9 teaches egress
...
printf '\n'
if docker cp "$CONTAINER:/labs/lab9/lab9-results.txt" "$RESULTS" >/dev/null 2>&1; then
...
printf '\n'; hr
printf '  Lab 9 complete. The image stays on your machine for the next lab.\n'
hr; printf '\n'
