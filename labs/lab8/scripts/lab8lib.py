...
def part2_order():
    """The order part 2 is actually taught in: labs 9 to 15.

    Kept separate from each lab's `part2` pairing because the two orders differ in one
    place - lab 11 (multimodal, pairs with lab 4) is taught before lab 12 (prompt
    injection, pairs with lab 3). Both are generated by gen_course.py from the part-2
    READMEs, 2026-09-22; the 2026-09-14 working titles they replaced are gone.
    """
